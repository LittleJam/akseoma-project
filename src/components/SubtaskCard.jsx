...
export default function SubtaskCard({ subtask, index, parentDisplayId, onToggle, darkMode }) {
  return (
    <div
      className={`ml-4 min-w-0 flex items-start gap-2 p-2 rounded-lg border transition duration-150 ${
    ...
    >
      ...
      />
      <span className={`text-[10px] font-mono flex-shrink-0 mt-0.5 ${darkMode ? 'text-gray-500' : 'text-gray-400'}`}>
